...
Integration tests need FFmpeg on your `PATH`. Test fixtures (small generated media files) are created automatically before the first run — no manual setup step.
