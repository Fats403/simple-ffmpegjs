...
describe("Gap Detection", () => {
  describe("detectVisualGaps", () => {
    ...
    describe("color clips as visual content", () => {
      it("should treat color clips as visual content (no gap where color clip exists)", () => {
        const clips = [
          { type: "video", position: 0, end: 3 },
          { type: "color", position: 3, end: 5 },
          { type: "video", position: 5, end: 8 },
        ];
        const gaps = detectVisualGaps(clips);
      ...
      it("should detect gap between video and color clip", () => {
        const clips = [
          { type: "video", position: 0, end: 3 },
          { type: "color", position: 5, end: 7 },
        ];
        const gaps = detectVisualGaps(clips);
      ...
      it("should not detect gap when color clip fills the start", () => {
        const clips = [
          { type: "color", position: 0, end: 2 },
          { type: "video", position: 2, end: 5 },
        ];
        const gaps = detectVisualGaps(clips);
